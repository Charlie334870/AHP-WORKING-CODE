...
export const SEED_PRODUCTS = [
    ...
    { id: "p9", shopId: "s1", name: "NGK Spark Plug ILZKAR7B11", sku: "ENG-SP-NGK1", category: "Engine", brand: "NGK", supplier: "NGK India", compatibleVehicles: ["Maruti Suzuki Swift", "Maruti Suzuki Baleno", "Toyota Innova"], buyPrice: 280, sellPrice: 450, mrp: 550, gstRate: 18, stock: 64, reservedStock: 0, minStock: 30, location: "Rack A-02", unit: "pcs", image: "⚙️", description: "Iridium spark plug for modern engines.", createdAt: Date.now(), updatedAt: Date.now(), isActive: true },
...
export function exportInventoryCSV(products) {
    const headers = ["SKU", "Product", "Category", "Brand", "Buy Price", "Sell Price", "MRP", "Stock", "Min Stock", "Location", "GST Rate", "Inventory Value", "Status"];
    const rows = products.map(p => [
        p.sku, p.name, p.category, p.brand, p.buyPrice, p.sellPrice, p.mrp || "", p.stock, p.minStock,
